...
- deps: lock file maintenance(pr [#532])
...
- deps: update rust crate uuid to 1.26.1(pr [#530])

## [0.9.7] - 2026-08-28

### Fixed

- deps: lock file maintenance(pr [#516])
...
- deps: update rust crate uuid to 1.25.0(pr [#522])
...
- deps: update rust crate clap to 4.6.6(pr [#512])
- deps: update rust crate thiserror to 2.0.20(pr [#513])
...
- bump MSRV 1.82 -> 1.87(pr [#508])

## [0.9.4] - 2026-06-26

### Changed

- ci-run sonarcloud security on main(pr [#491])
...
- deps: update rust crate uuid to 1.23.4(pr [#494])

## [0.9.3] - 2026-06-19

### Fixed

- deps: update dependency toolkit to v6.4.2(pr [#489])
...
- deps: update github/codeql-action action to v4.35.2(pr [#474])
- deps: update rust crate clap to 4.6.1(pr [#475])
...
- deps: update git2 packages to 0.21.0(pr [#481])

## [0.9.1] - 2026-03-27

### Added

- warn on major dependency bumps in commit history(pr [#459])
...
- deps: update rust crate clap to 4.6.0(pr [#464])
...
- deps: update actions/upload-artifact action to v7(pr [#454])
- deps: update dependency toolkit to v4.7.0(pr [#456])
...
- deps: update rust crate regex to 1.12.2(pr [#391])
- deps: update github/codeql-action action to v4(pr [#392])
...
- deps: update github/codeql-action action to v4.31.9(pr [#402])
...
[#391]: https://github.com/jerus-org/nextsv/pull/391
[#392]: https://github.com/jerus-org/nextsv/pull/392
...
[#402]: https://github.com/jerus-org/nextsv/pull/402
...
[#464]: https://github.com/jerus-org/nextsv/pull/464
...
[#474]: https://github.com/jerus-org/nextsv/pull/474
[#475]: https://github.com/jerus-org/nextsv/pull/475
...
[#489]: https://github.com/jerus-org/nextsv/pull/489
...
[#516]: https://github.com/jerus-org/nextsv/pull/516
...
[#530]: https://github.com/jerus-org/nextsv/pull/530
[#532]: https://github.com/jerus-org/nextsv/pull/532
[Unreleased]: https://github.com/jerus-org/nextsv/compare/v0.9.8...HEAD
[0.9.8]: https://github.com/jerus-org/nextsv/compare/v0.9.7...v0.9.8
